...
//			driver.findElement(By.xpath(".//a[@id='bus-link']")).click();
		...
		driver.findElement(By.xpath(".//li[@id='bustypeAC']")).click();
		List<WebElement> ac = driver.findElements(By.xpath("(.//a[@class='btn  outlined tertiary sm inactive button'])[1]"));
