...
public class Relative {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(".//input[2]")).sendKeys("rozman");
		Thread.sleep(3000);
		driver.findElement(By.xpath(".//a[1]")).click();
		Thread.sleep(3000);
		driver.navigate().back();
		Thread.sleep(3000);
		driver.findElement(By.xpath(".//div[2]/input[1]")).sendKeys("admin123@gmail.com");
		Thread.sleep(3000);
		driver.findElement(By.xpath(".//div[3]/a[1]")).click();
		Thread.sleep(3000);
		driver.navigate().back();
		Thread.sleep(3000);
